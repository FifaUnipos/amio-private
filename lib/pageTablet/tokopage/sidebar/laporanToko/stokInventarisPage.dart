...
class LaporanStokInventarisPage extends StatefulWidget {
  String token;
  ...
  @override
  State<LaporanStokInventarisPage> createState() =>
      LaporanPendapatanPerProdukState();
}

class LaporanPendapatanPerProdukState extends State<LaporanStokInventarisPage> {
    ...
    return RepaintBoundary(
      ...
      child: Column(
        children: [
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              ...
                                              getLaporanStok(
                                                ...
                                                listToko,
                                                _textvalueKeyword,
                                                textvalueOrderByReportInventoryStock,
                                                "pdf",
                                              ).then((value) {
                                                try {
                                                  launch(value['data']);
                            ...
                            children: [
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (context, i) {
                                  ...
                                  final stokMasuk =
                                      double.tryParse(
                                        stock['total_entry_good'].toString(),
                                      ) ??
                                      0;
                                  final stokKeluar =
                                      double.tryParse(
                                        stock['total_outgoing_good'].toString(),
                                      ) ??
                                      0;
          ...
          // FutureBuilder(
          //     future: getLaporanStok(context, widget.token, listToko,
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: List<Widget>.generate(
                                orderByLaporanStokInventarisText.length,
                                (int index) {
                                  final selected =
                                      valueOrderByReportInventoryStock == index;
                                  return ChoiceChip(
                                    ...
                                    label: Text(
                                      orderByLaporanStokInventarisText[index],
                                      style: heading4(
                                        FontWeight.w400,
                                    ...
                                    onSelected: (_) {
                                      setState(
                                        () => valueOrderByReportInventoryStock =
                                            index,
                                      );
                                    },
                                  );
                            ...
                            SizedBox(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  textOrderByReportInventoryStock =
                                      orderByLaporanStokInventarisText[valueOrderByReportInventoryStock];
                                  textvalueOrderByReportInventoryStock =
                                      orderByLaporanStokInventaris[valueOrderByReportInventoryStock];
                                  // refresh();
                                  Navigator.pop(context);

                                  final result = await getLaporanStok(
                                    context,
                                    widget.token,
                                    listToko,
                                    _textvalueKeyword,
  ...
  keyword(BuildContext context) {
    ...
    final List<String> textvalueKeyword = ['1H', '7H', '30H', '3B', '6B', '1Y'];
