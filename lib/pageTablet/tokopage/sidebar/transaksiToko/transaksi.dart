...
class _TransactionPageState extends State<TransactionPage>
  ...
  TextEditingController discountSearchController = TextEditingController();
                                        ...
                                        children: [
                                          ...
                                          FocusScope(
                                            child: Focus(
                                              ...
                                              child: TextField(
                                                cursorColor: primary500,
                                                controller: discountSearchController,
                          ...
                          child: (totalTransaksi ?? 0) < 0
                              ...
                              : GestureDetector(
                                  onTap: () async {
                                    ...
                                    final response = await submitTransactionApi(
                                      context,
                                      widget.token,
                                      cartMap
                                          .map(
                                    ...
                                    if (response['rc'] == '00') {
                                      bool isQris = await handleQrisResponse(
                                        context: context,
                                        response: response,
                                        token: widget.token,
                                        cart: cartMap
                ...
                children: [
                  ...
                  if (!splitShowKeypad) ...[
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          final response = await createTransactionBayar2(
                            context,
                            widget.token,
                            cartMap
                                .map((e) => Map<String, dynamic>.from(e))
                    ...
                    onTap: () async {
                      ...
                      if (uangTunaiController.text != 'Rp 0') {
                        if (uangTunaiController.text != '0') {
                          final response = await createTransactionBayar(
                            context,
                            widget.token,
