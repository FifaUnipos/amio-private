...
class _DaftarAkunTokoPageState extends State<DaftarAkunTokoPage> {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Icon(
                                        PhosphorIcons.number_circle_one_fill,
                                        color: primary500,
                                      ),
                                      Text(
                                        'Buat Toko',
                                  ...
                                  Column(
                                    children: [
                                      Icon(
                                        PhosphorIcons.number_circle_two,
                                        color: primary500,
                                      ),
                                      Text(
                                        'Buat Akun',
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Icon(
                              PhosphorIcons.number_circle_one,
                              color: primary500,
                            ),
                            Text(
                              'Buat Toko',
                        ...
                        Column(
                          children: [
                            Icon(
                              PhosphorIcons.number_circle_two_fill,
                              color: primary500,
                            ),
                            Text(
                              'Buat Akun',
  ...
  Container boxLoginRegister(Color color1, color2, String text, color3) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.login_rounded, size: 18, color: color2),
          Text(text),
        ],
      ),
    );
  ...
  Future register(context, page) async {
    ...
    final response = await http.post(
      // Uri.parse(ApiEndpoints.registerGlobalMerchbyOtp),
