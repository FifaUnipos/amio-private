...
class _AddPromoPageMobileState extends State<AddPromoPageMobile> {
  // Constants
  final String _createUrl = "https://unipos-dev-unipos-api-dev.yi8k7d.easypanel.host/api/discount/store";
  final String _updateUrl = "https://unipos-dev-unipos-api-dev.yi8k7d.easypanel.host/api/discount/update";
  final String _getProductsUrl = "https://unipos-dev-unipos-api-dev.yi8k7d.easypanel.host/api/discount/get-products";
  final String _showUrl = "https://unipos-dev-unipos-api-dev.yi8k7d.easypanel.host/api/discount/show";
  ...
  final TextEditingController _productSelectionController = TextEditingController();
      ...
      if (response.statusCode == 200) {
        ...
        if (data['rc'] == '00') {
           ...
           setState(() {
             ...
             _valueType = (d['discount_type'] == 'percentage') ? 'Persen' : 'Rupiah';
             _isActive = d['is_active'] == true; // API might return bool or string "true" logic check needed if string
             
             if (d['start_date'] != null && d['start_date'].toString().isNotEmpty && d['start_date'] != '0000-00-00') {
        ...
        if (data['status'] == '00' && data['data'] != null) {
           ...
           setState(() {
             ...
             if (initialSelection != null) {
               // Mark selected
               List<String> selectedIds = initialSelection.map((e) => e['productid'].toString()).toList();
  ...
  void _updateProductSelectionText() {
    if (_selectedProducts.isEmpty) {
      ...
      _productSelectionController.text = "${_selectedProducts.length} Produk Terpilih";
    }
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isUnavailable = product.discountStatus.isNotEmpty && 
                              (widget.editDiscount == null || product.discountId != widget.editDiscount!.id);

                        return CheckboxListTile(
                          title: Text(product.name, style: isUnavailable ? heading3(FontWeight.w600, Colors.grey, 'Outfit') : heading3(FontWeight.w600, bnw900, 'Outfit')),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(FormatCurrency.convertToIdr(product.price), style: body2(FontWeight.w400, bnw500, 'Outfit')),
                              if (isUnavailable)
                                Padding(
                                  padding: const EdgeInsets.only(top: 4.0),
                                  child: Text(product.discountStatus, style: body2(FontWeight.w400, Colors.red, 'Outfit')),
                                )
                            ],
                          ),
                          value: isUnavailable ? false : product.isSelected,
                          activeColor: primary500,
                          onChanged: isUnavailable ? null : (val) {
                            setStateDialog(() {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text("Simpan", style: heading3(FontWeight.w600, bnw100, 'Outfit')),
                    ),
                  ),
                ],
              ),
  ...
  Future<void> _saveDiscount() async {
    ...
    if (_type == 'Per Produk' && _selectedProducts.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Pilih minimal satu produk")));
      return;
    }
    ...
    try {
      ...
      final body = {
        ...
        "start_date": _activePeriod == 'Kustom Waktu' ? _startDateController.text : "",
        "end_date": _activePeriod == 'Kustom Waktu' ? _endDateController.text : "",
      ...
      if (response.statusCode == 200) {
         ...
         if (data['rc'] == '00') {
           ...
           ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(data['message'] ?? "Gagal menyimpan")));
         }
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.editDiscount == null ? "Tambah Promo" : "Ubah Promo", style: heading2(FontWeight.w700, bnw900, 'Outfit')),
        leading: IconButton(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildSelectCard("Umum", _type == "Umum", PhosphorIcons.squares_four_fill, () => setState(() => _type = "Umum")),
                  ),
                  SizedBox(width: 12),
                  Expanded(
                    child: _buildSelectCard("Per Produk", _type == "Per Produk", PhosphorIcons.shopping_bag_fill, () { 
                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: TextFormField(
                      ...
                      validator: (val) => _type == "Per Produk" && _selectedProducts.isEmpty ? "Wajib pilih produk" : null,
                    ),
                  ),
                ),
                SizedBox(height: 16),
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildSelectCard("Rupiah", _valueType == "Rupiah", PhosphorIcons.money_fill, () => setState(() => _valueType = "Rupiah")),
                  ),
                  SizedBox(width: 12),
                  Expanded(
                    child: _buildSelectCard("Persen", _valueType == "Persen", PhosphorIcons.percent, () => setState(() => _valueType = "Persen")),
                  ),
                ],
              ),
              SizedBox(height: 8),
              ...
              TextFormField(
                ...
                validator: (val) => val == null || val.isEmpty ? "Nilai wajib diisi" : null,
              ),
              ...
              Column(
                children: [
                   _buildPeriodSelector("Selamanya", _activePeriod == "Selamanya", PhosphorIcons.hourglass_high_fill, () => setState(() => _activePeriod = "Selamanya")),
                   SizedBox(height: 8),
                   _buildPeriodSelector("Kustom Waktu", _activePeriod == "Kustom Waktu", PhosphorIcons.timer_fill, () => setState(() => _activePeriod = "Kustom Waktu")),
                ],
              ),
                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: TextFormField(
                      ...
                      validator: (val) => _activePeriod == "Kustom Waktu" && (val == null || val.isEmpty) ? "Wajib diisi" : null,
                    ),
                  ),
                ),
                SizedBox(height: 16),
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Status Diskon", style: heading3(FontWeight.w600, bnw900, 'Outfit')),
                       Text(_isActive ? "Aktif" : "Tidak Aktif", style: body2(FontWeight.w400, bnw600, 'Outfit')),
                    ],
                  ),
                    ...
                    child: OutlinedButton(
                      onPressed: _isSaving ? null : () async {
                         ...
                         if (mounted) {
                           ...
                           ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Berhasil disimpan, silahkan tambah baru")));
                         }
                      },
                      ...
                      child: Text("Simpan & Tambah Baru", style: heading3(FontWeight.w600, primary500, 'Outfit')),
                    ),
                  ),
                  SizedBox(width: 16),
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text(widget.editDiscount == null ? "Tambah" : "Simpan", style: heading3(FontWeight.w600, bnw100, 'Outfit')),
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildSelectCard(String label, bool isSelected, IconData icon, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
  ...
  Widget _buildPeriodSelector(String label, bool isSelected, IconData icon, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
        width: double.infinity,
