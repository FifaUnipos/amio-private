      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: Icon(PhosphorIcons.arrow_left, size: size40, color: bnw900),
          ),
          GestureDetector(
            onTap: () {
              helpQuestionShow(context);
            },
            child: Icon(PhosphorIcons.question, size: size40, color: bnw900),
          ),
        ],
      ),
    ),
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: Icon(PhosphorIcons.arrow_left, size: 32, color: bnw900),
          ),
          GestureDetector(
            onTap: () {
              helpQuestionShow(context);
            },
            child: Icon(PhosphorIcons.question, size: 32, color: bnw900),
          ),
        ],
      ),
    ),
